...
{
    /**
     * Страница Обращения: данные из Supabase `escalation_message`.
     */
    public function __invoke(Request $request, SupabaseEscalationMessageClient $client): Response
    {
        $result = $client->fetchAll();
        $dialogColumn = (string) config('supabase.escalation_message.dialog_link_column', 'tg_chat_id');
        $dialogMatch = strtolower((string) config('supabase.escalation_message.dialog_link_match', 'chat_id'));
