...
* @see app/Http/Controllers/DialogiController.php:32
* @route '/dialogi'
*/
...
* @route '/retreats'
*/
export const retreats = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: retreats.url(options),
    method: 'get',
})
...
* @route '/retreats'
*/
retreats.url = (options?: RouteQueryOptions) => {
    return retreats.definition.url + queryParams(options)
}
...
* @route '/retreats'
*/
retreats.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: retreats.url(options),
    method: 'get',
})
...
* @route '/retreats'
*/
retreats.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: retreats.url(options),
    method: 'head',
})
...
* @route '/retreats'
*/
const retreatsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: retreats.url(options),
    method: 'get',
})
...
* @route '/retreats'
*/
retreatsForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: retreats.url(options),
    method: 'get',
})
...
* @route '/retreats'
*/
retreatsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: retreats.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
