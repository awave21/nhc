    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Двухфакторная аутентификация теперь включена. Отсканируйте QR-код или введите ключ настройки в своем приложении-аутентификаторе.',
                buttonText: 'Закрыть',
            };
        }
        ...
        return {
            ...
            description:
                'Чтобы завершить включение двухфакторной аутентификации, отсканируйте QR-код или введите ключ настройки в своем приложении-аутентификаторе',
            buttonText: 'Продолжить',
        };
