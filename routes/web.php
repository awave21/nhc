...
use App\Http\Controllers\DialogiMessageDeleteController;
use App\Http\Controllers\DialogiMoreController;
use App\Http\Controllers\DialogiSendController;
use App\Http\Controllers\DialogiTakeoverController;
...
use App\Http\Controllers\RetreatTariffStatusController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('dialogi/takeover', [DialogiTakeoverController::class, 'store'])->name('dialogi.takeover.store');
    Route::delete('dialogi/takeover', [DialogiTakeoverController::class, 'destroy'])->name('dialogi.takeover.destroy');
    ...
    Route::patch('retreats/tariffs/{tariff}/status', RetreatTariffStatusController::class)->name('retreats.tariffs.status');
